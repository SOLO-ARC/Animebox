...
class AccountSelectActivity : FragmentActivity(), BiometricCallback {
    ...
    private fun navigateToMainActivity() {
        hasLoggedIn = true
        // We want to propagate any intent we get here to AnimeBoxMainActivity since this is just an intermediary
        openActivity(com.lagradost.cloudstream3.ui.animebox.AnimeBoxMainActivity::class.java, baseIntent = intent)
